...
<div style="display:flex; justify-content:space-between; width:100%; margin-bottom:10px;">
  <div>
    <strong>Research Engineer</strong>, GBLS Co.,Ltd., Busan, Republic of Korea<br>
    Mechanical Design Team, R&D Department
  </div>
  <div>2023.03 – 2023.08</div>
</div>
...
"Designing Ultralight Nanolattices: Multiscale Optimization of Geometry and Size Effects", 
<em>Thin-walled Structures</em>, Submitted.
</div>
...
<div style="display:flex; justify-content:space-between; margin-bottom:10px;">
  <div><strong>Outstanding Case Award</strong>, 13th Challenge Semester Program, Ewha Womans University</div>
  <div>2021.12</div>
</div>
